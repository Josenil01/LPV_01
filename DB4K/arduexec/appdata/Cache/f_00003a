...
Blockly.Css.CONTENT = [
  ...
  */
  ...
  '}',
 /* ****************************************************************************/
 /* (Modified by RLQ DB4K - Changed stroke  width . Origianal = 1) */
  '.blocklyAngleCircle {',
    'stroke: #444;',
    'stroke-width: 2;',
    'fill: #ddd;',
 ...
 //----------------------------------------------------------------------------- 
 /* ****************************************************************************/
  /* (Modified by RLQ DB4K - Changed fill color  and opacity. Orignal = 8) */
  '.blocklyAngleGauge {',
    'fill: #f88;',
    'fill-opacity: .2;',
  '}',
 //----------------------------------------------------------------------------- 
 /* ****************************************************************************/
  /* (Modified by RLQ DB4K - Changed stroke color (Original =  #f00) and width (Original = 2) ) */
  '.blocklyAngleLine {',
    'stroke: #fc0;', 
    'stroke-width: 8;',
    'stroke-linecap: round;',
  ...
  //***************************************************************************
   /* Modified by RLQ DB4k (Included this style) */
  '.blocklyTreeSeparatorStrong{',
  '  border-bottom: solid #e5e5e5 1px;',
  '  height: 0px;',
  '  margin: 5px 0;',
  '}',
