...
Blockly.Toolbox.prototype.init = function() {
  ...
  this.position();
  // *******************************************************************
  //Modified By RLQ DB4K (inluded this function call)
  ...
  function syncTrees(treeIn, treeOut, pathToMedia) {
    ...
    for (var i = 0, childIn; childIn = treeIn.childNodes[i]; i++) {
      ...
      switch (childIn.tagName.toUpperCase()) {
		...
		case 'SEP_STRONG':
          treeOut.add(new Blockly.Toolbox.TreeSeparatorStrong());
          break;
		// ------------------------------------------------------------------------------------------
...
//Modified by RLQ-DB4K (Included this function)
Blockly.Toolbox.TreeSeparatorStrong = function() {
  Blockly.Toolbox.TreeNode.call(this, null, '',
      Blockly.Toolbox.TreeSeparatorStrong.CONFIG_);
};
goog.inherits(Blockly.Toolbox.TreeSeparatorStrong, Blockly.Toolbox.TreeNode);
//
//---------------------------------------------------------------------------------------------------
...
/* Modified By RLQ-DB4K  - Included this atrribute */
Blockly.Toolbox.TreeSeparatorStrong.CONFIG_ = {
  cssTreeRow: 'blocklyTreeSeparatorStrong'
};
/**/
//----------------------------------------------------------------------------------------------
...
/* Modified By RLQ-DB4K  - This function changes menu intens colors  */
...
function changeMenuItensColor(){
    ...
    var menuMatematica=document.getElementById(":2"); //Matemática
		...
		var menuLED=document.getElementById(":3"); //LED
		var textomenuLED = document.getElementById(":3.label"); //textomenuLED
		var menuServoMotor=document.getElementById(":4"); //ServoMotor
		var textomenuServoMotor= document.getElementById(":4.label"); //textoServoMotor
		var menuSom=document.getElementById(":5"); //Som
		var textomenuSom = document.getElementById(":5.label"); //TextoSom
	  var menuSensores=document.getElementById(":6"); //Sensores
		var textomenuSensores = document.getElementById(":6.label"); //TextoSensores
		var menuCarrinho=document.getElementById(":7"); //Carrinho
		var textomenuCarrinho = document.getElementById(":7.label"); //TextoCarrinho
		var menuBraco=document.getElementById(":8"); //Braço
		var textomenuBraco = document.getElementById(":8.label"); //TextoBraço
    //		var menuDisplay=document.getElementById(":6"); //Display
    //		var textomenuDisplay = document.getElementById(":6.label"); //TextoDisplay
		//var menuOption=document.getElementById(":h"); //Braço - Z teacher
		//var textomenuOption = document.getElementById(":h.label"); //TextoBraço - Z-teacher
		//var menuOption2=document.getElementById(":j"); //Braço - Z teacher
		//var textomenuOption2 = document.getElementById(":g.label"); //TextoBraço - Z-teacher

    //Controla as cores do item Controle id = 1
		textomenuControle.style.color="white";
		menuControle.style.backgroundColor="#D07D00";
		menuControle.onmouseover=function(){menuControle.style.backgroundColor="#ff9a02"};
		menuControle.onmouseout=function(){menuControle.style.backgroundColor="#D07D00"};
    //Controla as cores do item Matematica id = 2
		textomenuMatematica.style.color="white";
		menuMatematica.style.backgroundColor="#1d6205";
		menuMatematica.onmouseover=function(){menuMatematica.style.backgroundColor="#33be02"};
		menuMatematica.onmouseout=function(){menuMatematica.style.backgroundColor="#1d6205"};
    //Controla as cores do item LED id = 5
		textomenuLED.style.color="white";
		menuLED.style.backgroundColor="#009732";
		menuLED.onmouseover=function(){menuLED.style.backgroundColor="#00e54c"};
		menuLED.onmouseout=function(){menuLED.style.backgroundColor="#009732"};
		//Controla as cores do item ServoMotor id  = 7
		textomenuServoMotor.style.color="white";
		menuServoMotor.style.backgroundColor="#0096CD";
		menuServoMotor.onmouseover=function(){menuServoMotor.style.backgroundColor="#02b9fc"};
		menuServoMotor.onmouseout=function(){menuServoMotor.style.backgroundColor="#0096CD"};
		//Controla as cores do item Som id = 9
    textomenuSom.style.color="white";
		menuSom.style.backgroundColor="#00856b";
		menuSom.onmouseover=function(){menuSom.style.backgroundColor="#01d5ac"};
		menuSom.onmouseout=function(){menuSom.style.backgroundColor="#00856b"};
    //Controla as cores do item Carrinho
    textomenuCarrinho.style.color="white";
    menuCarrinho.style.backgroundColor="#6600CC";
    menuCarrinho.onmouseover=function(){menuCarrinho.style.backgroundColor="#3E017B"};
    menuCarrinho.onmouseout=function(){menuCarrinho.style.backgroundColor="#6600CC"};
    //Controla as cores do item Braco
    textomenuBraco.style.color="white";
    menuBraco.style.backgroundColor="#CCAA00";
    menuBraco.onmouseover=function(){menuBraco.style.backgroundColor="#AE9203"};
    menuBraco.onmouseout=function(){menuBraco.style.backgroundColor="#CCAA00"};
    //Controla as cores do item Som
    textomenuSom.style.color="white";
    ...
    //Controla as cores do item Sensores id = a
    textomenuSensores.style.color="white";
    menuSensores.style.backgroundColor="#99CC00";
    menuSensores.onmouseover=function(){menuSensores.style.backgroundColor="#7B9E14"};
    menuSensores.onmouseout=function(){menuSensores.style.backgroundColor="#99CC00"};
